...
int main(int argc, char **argv) {
    ...
    printf("  Rank %d: summed its local_chunk of %d elements => local_sum = %lld\n",
           rank, chunk_size, local_sum);

    /* GATHER: collect one long long (local_sum) from every process into all_sums on root, in rank order. */
